<!DOCTYPE html>
	...
	<head>
		...
		<body>
			...
			<!-- start banner Area -->
			<section class="banner-area relative" id="home" data-parallax="scroll" data-image-src="/assets/img/header-bg.jpg">
					...
					<div class="row fullscreen">
						...
						<div class="head-bottom-meta d-flex justify-content-between align-items-end col-lg-12">
							...
							<div class="col-lg-6 flex-row d-flex meta-right no-padding justify-content-end">
								...
								<img class="img-fluid user-img" src="/assets/img/user.jpg" alt="">
							</div>
						</div>												
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-6 travel-left">
							<div class="single-travel media pb-70">
							  <img class="img-fluid d-flex  mr-3" src="/assets/img/t1.jpg" alt="">
							  <div class="dates">
							  	<span>20</span>
							  	<p>Dec</p>
							  </div>
							...
							<div class="single-travel media">
							  <img class="img-fluid d-flex  mr-3" src="/assets/img/t3.jpg" alt="">
							  <div class="dates">
							  	<span>20</span>
							  	<p>Dec</p>
							  </div>							  
						...
						<div class="col-lg-6 travel-right">
							<div class="single-travel media pb-70">
							  <img class="img-fluid d-flex  mr-3" src="/assets/img/t2.jpg" alt="">
							  <div class="dates">
							  	<span>20</span>
							  	<p>Dec</p>
							  </div>							  
							...
							<div class="single-travel media">
							  <img class="img-fluid d-flex  mr-3" src="/assets/img/t4.jpg" alt="">
							  <div class="dates">
							  	<span>20</span>
							  	<p>Dec</p>
							  </div>							  
			...
			<section class="fashion-area section-gap" id="fashion">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6 single-fashion">
							<img class="img-fluid" src="/assets/img/f3.jpg" alt="">
							<p class="date">10 Jan 2018</p>
							<h4><a href="#">Addiction When Gambling
							Becomes A Problem</a></h4>
							<p>
						...
						<div class="col-lg-3 col-md-6 single-fashion">
							<img class="img-fluid" src="/assets/img/f4.jpg" alt="">
							<p class="date">10 Jan 2018</p>
							<h4><a href="#">Addiction When Gambling
							Becomes A Problem</a></h4>
							<p>
