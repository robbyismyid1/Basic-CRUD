                        ...
                        <div class="post-lists">
                            <div class="single-list flex-row d-flex">
                                <div class="thumb">
                                    ...
                                    <img src="/assets/img/asset/l1.jpg" alt="">
                                </div>
                                <div class="detail">
                            ...
                            <div class="single-list flex-row d-flex">
                                <div class="thumb">
                                    ...
                                    <img src="/assets/img/asset/l2.jpg" alt="">
                                </div>
                                <div class="detail">
                                    <a href="#"><h4 class="pb-20">Addiction When Gambling <br>
                                    Becomes A Problem</h4></a>
                            ...
                            <div class="single-list flex-row d-flex">
                                <div class="thumb">
                                    ...
                                    <img src="/assets/img/asset/l3.jpg" alt="">
                                </div>
                                <div class="detail">
                                    <a href="#"><h4 class="pb-20">Addiction When Gambling <br>
                                    Becomes A Problem</h4></a>
                            ...
                            <div class="single-list flex-row d-flex">
                                <div class="thumb">
                                    ...
                                    <img src="/assets/img/asset/l4.jpg" alt="">
                                </div>
                                <div class="detail">
                                    <a href="#"><h4 class="pb-20">Addiction When Gambling <br>
                                    Becomes A Problem</h4></a>
